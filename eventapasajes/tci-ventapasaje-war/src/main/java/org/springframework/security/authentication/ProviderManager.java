...
//            }
            ...
            try {
                if (provider instanceof AnonymousAuthenticationProvider) {
                    ...
                    TciAuthenticationToken token
                            = new TciAuthenticationToken(authentication.getPrincipal(), authentication.getCredentials(),

                            ((TciAuthenticationToken)authentication).getPortal());
     ...
     * will have its {@link org.springframework.security.core.CredentialsContainer#eraseCredentials() eraseCredentials} method called before it is returned
    ...
    /**
     * Sets the {@link org.springframework.security.authentication.AuthenticationProvider} objects to be used for authentication.
     *
